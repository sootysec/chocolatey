...
$url        = 'https://github.com/ChangemakerStudios/Papercut-SMTP/releases/download/5.7.0/Papercut.Setup.exe'
...
$packageArgs = @{
  ...
  softwareName  = 'Papercut*'

  checksum      = '5F54B0FF3DEB2210EC9FDDD725DF684050ABB347576DF34665AABC489B052258'
  checksumType  = 'sha256'
